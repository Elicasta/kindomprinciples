/* Final authoritative renderer for Lesson 1 slides 16–22. */
(function(){
  'use strict';

  const FINAL = [
    {index:15,type:'Framework',title:'The Three Identity Pressures',html:'<div class="slide sl-te kp-final-slide" data-i="15"><div class="sl-te-n">16</div><div class="sl-te-h">The Three Identity <span class="acc">Pressures</span></div><ul class="sl-pts"><li><strong>Appetite:</strong> What do you desire?</li><li><strong>Approval:</strong> Whose validation do you require?</li><li><strong>Control:</strong> Whose will do you follow?</li></ul><div class="sl-te-ref">Identity is tested through desire, validation, and control.</div></div>'},
  ...
  function repairContainer(container){
    ...
    try{
      ...
      container.dataset.kpFinalSlides='7';
  ...
  function repairLabels(){
    ...
    FINAL.forEach(function(def){
      ...
      const typeLeaf=leaves.find(function(el){return ['TRIAD','PRESSURE','PRACTICE','FINAL','CLOSING'].includes((el.textContent||'').trim().toUpperCase());});
  ...
  function boot(){
    ...
    document.documentElement.dataset.kpFinalSlides='7';
  }
